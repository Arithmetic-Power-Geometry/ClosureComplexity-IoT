...
Akhtar, M. A. K. (2026). *Equally Damaged, Unequally Recoverable: Closure Complexity for Target-Relative Structural Repair of Failure-Degraded IoT Networks* (Version V1). Zenodo.

https://doi.org/10.5281/zenodo.22032536

**Theoretical foundation / derived from**

Akhtar, M. A. K. (2026). *Closure Complexity: A Variational Theory of Minimal Structural Repair.*

https://doi.org/10.2139/ssrn.6734724

**Software repository**

https://github.com/Arithmetic-Power-Geometry/ClosureComplexity-IoT
